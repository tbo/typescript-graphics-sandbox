...
module THREE {
    ...
    export class Geometry {
        ...
        /**
         * The array of vertices hold every position of points of the obj.
         ...
         * The array of faces describe how each vertex in the obj is connected with each other.
    ...
    export class JSONLoader extends Loader {
        ...
        /**
         * @param url
         * @param callback. This function will be called with the loaded obj as an instance of geometry when the load is completed.
         * @param texturePath If not specified, textures will be assumed to be in the same folder as the Javascript obj file.
         */
    ...
    export class SceneLoader {
        ...
        /**
         * @param url
         * @param callbackFinished This function will be called with the loaded obj as an instance of scene when the load is completed.
         */
